...
public class JavaSubstring {
    public static void main(String[] args) {
        // First we instantiate our Scanner Object to take in our inputs:
        Scanner scanner = new Scanner(System.in);

        // We then parse our inputs into the correct variables:
        String s = scanner.next();
        int start = scanner.nextInt();
        int end = scanner.nextInt();

        // We then formulate our output based on the variables we have created:
